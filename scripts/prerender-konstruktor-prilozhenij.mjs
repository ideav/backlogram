...
<article id="kp-prerender" itemscope itemtype="https://schema.org/Service">
  <header>
    ...
    <p class="kp-prerender__lead" itemprop="description">
      ...
      По задачам это аналог Excel для команды: те же таблицы и расчёты, только данные лежат в базе,
      а не в файлах на почте.
    </p>
  ...
  <footer class="kp-prerender__footer">
    ...
    <p style="margin-top:0.6rem">
      Читайте в блоге:
      <a href="https://ideav.ru/blog/posts/pervyi-rossiiskii-analog-airtable/">Первый российский аналог Airtable</a> ·
      <a href="https://ideav.ru/blog/posts/predposylki-no-code-konstruktora-integram/">Предпосылки no-code конструктора Интеграм</a> ·
