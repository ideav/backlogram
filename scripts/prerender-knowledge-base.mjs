...
const groups = [
  ...
  },
  {
    ...
    blurb:
      'Когда у разных ролей разный объём видимых данных, файлы должны оставаться внутри контура компании, а служба безопасности спрашивает про шифрование, резервирование и вендор-лок.',
    slugs: ['05-access-rights', '15-local-control-files', '23-security-fault-tolerance'],
  },
  {
  ...
  },
  {
    ...
    blurb:
      'Что такое информационная система, из чего она состоит и как собрать её на low-code платформе с ИИ вместо заказной разработки.',
    slugs: ['22-information-system-constructor'],
  },
]
