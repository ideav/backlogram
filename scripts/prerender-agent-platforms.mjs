...
<article id="ap-prerender" itemscope itemtype="https://schema.org/Article">
  <header>
    ...
    <p class="ap-prerender__lead" itemprop="description">
      Информационная система и платформы, на которых её собирают, за последние два года разошлись:
      систему учёта больше не пишут с нуля, её собирает агент поверх готовой платформы.
