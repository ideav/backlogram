...
const landingCards = [
  ...
  {
    slug: 'kvintety-ili-tablicy',
    eyebrow: 'Опросник · архитектура хранения',
    title: 'Квинтеты, обычные таблицы или комбинация',
    subtitle:
      'Тринадцать вопросов о проекте: баллы трёх способов хранения и человеко-часы, в которые каждый обойдётся за три года.',
  },
  {
    slug: 'tokens',
    eyebrow: 'Цены · токены',
