...
const faq = [
  ...
  {
    q: 'Чем CRM-конструктор отличается от готовой CRM-системы?',
    a: 'Готовая CRM-система приходит с зашитой моделью данных и готовым процессом: вы принимаете чужую логику и настраиваете её в отведённых рамках. CRM-конструктор даёт собрать модель под свой процесс — свои сущности, поля, воронки и правила переходов между этапами. Коробка выигрывает в первый день, конструктор — там, где процесс не укладывается в шаблон и упирается в «это изменить нельзя».',
  },
]
...
<article id="sr-prerender" itemscope itemtype="https://schema.org/Article">
  <header>
    ...
    <p class="sr-prerender__lead" itemprop="description">
      CRM-система — что это такое: программа, где живут клиенты, сделки и история общения с ними.
      Битрикс24 и AmoCRM — готовые CRM-системы, и в них есть вещи, которые нельзя изменить даже за
      деньги: они зашиты в ядро продукта.
      Типичный пример — переключение воронок и перенос лида из одной воронки в другую.
  ...
  <footer class="sr-prerender__footer">
    ...
    <p style="margin-top:0.6rem">
      Читайте в блоге:
      <a href="https://ideav.ru/blog/posts/bitrix24-ai-vibecode-i-sistemnaya-prostota/">Битрикс24 прикручивает AI к сложности</a> ·
      <a href="https://ideav.ru/blog/posts/crm-sistema-dlya-srednego-biznesa/">CRM-система для среднего бизнеса</a>
    </p>
  </footer>
</article>
<style>
