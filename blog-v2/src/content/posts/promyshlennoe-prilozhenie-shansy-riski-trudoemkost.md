...
![Инфографика: 63% практикующих вайб-кодинг — не разработчики; понимание собственного кода на 17% хуже у решавших задачу с ИИ; 10,3% приложений отдавали чужие данные любому; срок до первого запуска — от 3 недель до 3+ лет](/uploads/shansy-kto-sobiraet.png)
...
![Три метрики GitClear на 211 млн изменённых строк кода: скопированные строки выросли с 8,3% до 12,3%, изменения с рефакторингом упали с 25% до менее 10%, переписанное в первые две недели выросло с 3,1% до 5,7%](/uploads/shansy-kodovaya-baza.png)
