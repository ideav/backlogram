...
![enter image description here](https://leonardo.osnova.io/86159450-ff8e-5185-95d4-cf90a23264b0)
...
![Список таблиц Интеграма](https://leonardo.osnova.io/7bd9cc67-3331-50e1-b610-84d3c4f1e59e)
...
![Структура данных в Интеграм](https://leonardo.osnova.io/92677e71-75d2-5834-8ef7-0ccebbb71b8b)
...
![Редактирование отдельного пользователя для доступа к API](https://leonardo.osnova.io/57555710-af8f-58a6-836c-efdff2bd0132)

У пользователя есть Роли – в данном случае api, и для неё должен быть задан доступ к запросам, например, так:

![Состав роли api](https://leonardo.osnova.io/274f7d08-2a12-52ee-8f3f-b3d2a0509ac7)

Далее в Интеграме выбираем нужный нам запрос к данным (или делаем его в конструкторе запросов) и запускаем:

![Отчет по запросу в Интеграме](https://leonardo.osnova.io/1c3df65c-a903-5aa4-9e63-75a99918c80a)
...
![enter image description here](https://leonardo.osnova.io/4ef84129-e5e4-533c-9320-a2a7eddcf377)

Зададим адрес нашего отчета и нажмем ОК:

![enter image description here](https://leonardo.osnova.io/c24a7bfc-14e5-5918-8694-0a06d1cca310)
...
![enter image description here](https://leonardo.osnova.io/c25c7569-b0df-55db-bf3d-840dc1bef6ed)
...
![Данные из отчета Интеграма в Power BI](https://leonardo.osnova.io/36c17796-4d29-5abd-873d-1b3611d5da2f)
