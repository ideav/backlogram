...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/a8ae3ce6-89c7-50ec-898f-bcf263eb83f2)
...
![Мы видим здесь 5 связанных уровней данных, по которым у нас построен запрос](https://leonardo.osnova.io/de1e2d12-dbfa-51fb-b7f3-629e7787d7ed) _Мы видим здесь 5 связанных уровней данных, по которым у нас построен запрос_

Запустить специальный режим работы с отчетом можно вот этой кнопкой в конструкторе запросов.

![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/96d7b17e-1612-52eb-a9dd-f919f1888599)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/cf99271f-9474-58f1-a7a8-bb708ed3c346)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/c29a51b6-e7c0-55f1-aae3-fb731147a63f)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/3e9c526c-3ecb-542a-a00b-a6ce69b0fc87)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/606becd1-60f2-579f-ba49-6daf942fe19f)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/a16d2413-3a81-5e80-9ee3-283c9a2a90e9)

Это будет стоимость услуги для iPhone 12 и, задав цену, мы выбираем эту модель из выпадающего списка.

![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/ce864f85-beb4-5138-b7b1-fb359ac582b7)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/d3be2e4a-81b1-549b-a611-2311597ab775)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/d50c9736-aadc-5aa3-8c4f-e973af7cbd49)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/19f66fa5-b8f2-5cfb-b9b7-47f681f15f82)
...
![Интеллектуальный отчет для редактирования данных в таблицах](https://leonardo.osnova.io/bbceb15d-19cb-5410-a16a-45329282a164)
...
![Конструктор запросов и Структура таблиц](https://leonardo.osnova.io/db202761-48c3-5af2-8f0b-6d3bb4a572b2) _Конструктор запросов и Структура таблиц_
...
![enter image description here](https://blog.ideav.online/content/images/20250821105014-smartq_id.png)
