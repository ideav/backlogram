        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              ...
              >
                Автоматизация без программистов
              </span>
            </motion.div>

            <div className={`hero-copy-opacity-target transition-opacity duration-700 ease-in-out ${isHeroTeaserActive ? 'opacity-[0.10] dark:opacity-[0.20]' : 'opacity-100'}`}>
              <motion.h1
              ...
              >
<span className="text-blue-500 italic">Интеграм</span> — российский no-code конструктор приложений и баз данных: замена Excel и аналог Airtable для бизнеса
              </motion.h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-3 text-sm font-semibold text-slate-600 dark:text-slate-300">Что происходит с вашей таблицей:</p>
              <ul className="mt-1.5 grid sm:grid-cols-2 gap-x-6 gap-y-1.5 text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Вы получаете приложение с SSO, API, аудитом и корпоративным стилем. Импорт/экспорт: Excel, JSON, API. Автоматическое обновление данных из Excel по расписанию.'
              }
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-lg">
              Языковые модели и агенты берут на себя большую часть работы по программированию и интеграции — мы используем их полную мощь, чтобы доставлять решения быстрее. Загрузите Excel — ИИ распознает структуру, предложит типы данных и создаст приложение. Автоматизация Excel процессов через ИИ: от парсинга файлов до генерации отчётов.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex flex-col hover:border-slate-300 dark:hover:border-slate-700 transition-all shadow-sm dark:shadow-none">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 -mt-3 mb-6">Попробуйте конвертацию Excel в приложение бесплатно. Загрузите свою таблицу и посмотрите результат.</p>
            ...
            <div className="p-8 rounded-3xl border-2 border-blue-600 bg-white dark:bg-slate-950 relative flex flex-col shadow-[0_0_50px_-12px_rgba(37,99,235,0.3)]">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 -mt-3 mb-6">Автоматизация Excel таблиц, дашборды, формы, права доступа. Несколько пользователей, командная работа.</p>
              <ul className="space-y-3 mb-8 flex-1">
                {[
            ...
            <div className="p-8 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex flex-col hover:border-slate-300 dark:hover:border-slate-700 transition-all shadow-sm dark:shadow-none">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 -mt-3 mb-6">Для корпоративных объёмов. Хранение больших данных в таблицах без ограничений. Неограниченное количество записей. On-premise или облако.</p>
              <ul className="space-y-3 mb-8 flex-1">
                {[
      ...
      {/* 15. FAQ (issue #387, #433 — AI-native позиционирование вместо Instagram-disambiguation) */}
