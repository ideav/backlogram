      ...
      <section className="pt-28 pb-12 lg:pt-36 lg:pb-16 border-b border-slate-200 dark:border-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
            CRM-система — что это такое: программа, где живут клиенты, сделки и история общения с
            ними. Битрикс24 и AmoCRM — готовые CRM-системы, и в них есть вещи, которые нельзя
            изменить даже за деньги: они зашиты в ядро продукта.
