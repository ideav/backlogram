    ...
    <div className="overflow-hidden">
      ...
      <section className="py-14 border-b border-slate-200 dark:border-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
            Информационная система и технологии её обработки в законе идут одной связкой: сама информация
            в базах данных, технологии, которые её обрабатывают, и технические средства, на которых всё
            это работает.
          </p>
      ...
      <section className="py-14 border-b border-slate-200 dark:border-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8 max-w-2xl">
            Качество ИС оценивают по характеристикам модели ГОСТ Р ИСО/МЭК 25010. Информационная система
            и безопасность связаны здесь напрямую: защищённость стоит в одном ряду с надёжностью и
            производительностью, отдельной надстройкой её не сделать. Главные характеристики:
          </p>
